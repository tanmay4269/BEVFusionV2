...
class BEVFormerHead(DETRHead):
    ...
    @auto_fp16(apply_to=('mlvl_img_feats'))
    def forward(self, mlvl_img_feats, img_metas, prev_bev=None,  only_bev=False):
        """Forward function.
        Args:
            mlvl_img_feats (tuple[Tensor]): Features from the upstream
